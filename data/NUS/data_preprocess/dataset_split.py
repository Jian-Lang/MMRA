...
if __name__ == '__main__':
    initial_data_frame = pd.read_pickle(r'D:\MultiModalPopularityPrediction\data\NUS\data.pkl')
    ...
    train_data_frame.to_pickle(r'D:\MultiModalPopularityPrediction\data\NUS\train.pkl')

    test_data_frame.to_pickle(r'D:\MultiModalPopularityPrediction\data\NUS\test.pkl')

    valid_data_frame.to_pickle(r'D:\MultiModalPopularityPrediction\data\NUS\valid.pkl')
