...
if __name__ == '__main__':
    initial_data_frame = pd.read_pickle(r'D:\MultiModalPopularityPrediction\data\vine\data.pkl')
    ...
    train_data_frame.to_pickle(r'D:\MultiModalPopularityPrediction\data\vine\train.pkl')

    test_data_frame.to_pickle(r'D:\MultiModalPopularityPrediction\data\vine\test.pkl')

    valid_data_frame.to_pickle(r'D:\MultiModalPopularityPrediction\data\vine\valid.pkl')
