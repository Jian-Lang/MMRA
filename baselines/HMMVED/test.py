...
def main():
    ...
    parser.add_argument('--model_path',
                        default=r'D:\MultiModalPopularityPrediction\baselines\HMMVED\train_results\train_HMMVED_baselines_data_vine_MSE_2024-01-21_20-29-09\trained_model\model_3.pth',
