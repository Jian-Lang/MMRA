...
from model import ContextualLSTM
import random
...
def train_val(args):
    ...
    model = ContextualLSTM(768, 768, 50, 1)
...
def main():
    ...
    parser.add_argument('--dataset_id', default='MicroLens100k', type=str,
    ...
    parser.add_argument('--latent_dim', default=50, type=int, help='latent dimension of each modal')
